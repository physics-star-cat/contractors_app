...
export const metadata: Metadata = {
  ...
  description:
    'What to do when material costs go up or scope creeps during a job. How to talk to clients, write variation orders, and protect yourself in the original quote.',
  alternates: { canonical: '/guides/handling-price-increases-mid-job/', languages: { 'en-AU': '/au/guides/handling-price-increases-mid-job/', 'en-CA': '/ca/guides/handling-price-increases-mid-job/', 'en-GB': '/guides/handling-price-increases-mid-job/', 'en-US': '/us/guides/handling-price-increases-mid-job/', 'x-default': '/guides/handling-price-increases-mid-job/' } },
}
...
export default function HandlingPriceIncreasesMidJobPage() {
  return (
    <div className="guide">
      ...
      <p>
        You quoted the job in January. You started in March. Between then and now, timber
        went up 15%, your supplier changed their delivery charges, and the client decided
        they want underfloor heating after all. Your original number is now fiction.
      </p>
      <p>
      ...
      <p>
        Material prices move. Sometimes slowly, sometimes overnight. If you quoted three
      ...
      <p>
        &quot;Happy to do that. Let me price it up and send you a variation so we are both
      ...
      <ol>
        <li>
          ...
          have gone up.&quot; Say &quot;the plywood I quoted at £42 a sheet is now £51 a
          sheet. That adds £270 to the materials bill.&quot; Numbers are harder to argue with
          than feelings.
        </li>
        <li>
        ...
        <li>
          ...
          the same plywood at the new price, or I can source a similar product at £45 a
      ...
      <p>
        A variation order is just a written record of a change to the original scope or
        price. It does not need to be complicated. A short email or message that says:
      </p>

      <ASCIIBox title="Example Variation">
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          <span className="guide__highlight">Variation #1</span> — 15 March
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          Additional work: install underfloor heating to bathroom
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          Materials: £380 (heating mat, thermostat, self-levelling compound)
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          Labour: £450 (1.5 days)
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          Additional cost: <span className="guide__highlight">£830</span>
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
          Revised total: <span className="guide__highlight">£8,230</span> (was £7,400)
        </p>
      </ASCIIBox>
      ...
      <p>
        ...
        contractors who handle them well are the ones who quoted honestly in the first

  ...
  return (
    <div className="guide">
      ...
      <p>
        ...
        number for each line item: tiles £2,000. That is not an estimate. That is a guess
        dressed up as a fact. Real costs are ranges. Tiles could be £1,800 if your usual
        supplier has stock, or £2,400 if they do not and you are ordering from someone new.
      </p>

      <h2>the five uncertainty tiers</h2>

      <p>
        Not every line item in your quote carries the same risk. A skip hire from the company
        ...
        <table className="guide__table">
          ...
          <tbody>
            <tr>
              ...
              <td>+/- 2%</td>
              <td>Skip hire, fixed-price supplier quote in writing</td>
            </tr>
            <tr>
      ...
      <p>
        ...
        you did two years ago in a different postcode? That is High at best.
      </p>
      ...
      <p>
        ...
        for the waste. Your base estimate comes to £6,400.
      </p>
      ...
      <ASCIIBox title="Line Items">
        <table className="guide__table">
          ...
          <tbody>
            ...
            <tr>
              <td>Fixtures (basin, toilet, taps)</td>
              <td>£800</td>
              <td className="guide__highlight">Medium</td>
            ...
            <tr>
              ...
              <td>£300</td>
              <td className="guide__highlight">Certain</td>
              <td>Fixed price from your regular skip company</td>
            </tr>
          </tbody>
        </table>
      </ASCIIBox>
      ...
      <p>
        If you quoted £6,400 flat, you are pricing for the scenario where every single line
      ...
      <ASCIIBox title="Simulation Output">
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          Base estimate: <span className="guide__highlight">£6,400</span>
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          P50 (coin-flip odds): <span className="guide__highlight">£6,720</span>
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '8px' }}>
          P80 (recommended quote): <span className="guide__highlight">£7,180</span>
        </p>
        <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
          P95 (worst-case buffer): <span className="guide__highlight">£7,840</span>
        </p>
      </ASCIIBox>

      <p>
        The difference between £6,400 and £7,180 is £780 — about 12%. But it is not a
      ...
      <p>
        ...
        job with a good client? P50 might be fine. A fixed-price kitchen for a solicitor who
        will hold you to every penny? Quote at P80 or P95 and protect yourself.
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          £30/hour for a three-week job is £900. That is real money. Price it.
        </li>
        <li>

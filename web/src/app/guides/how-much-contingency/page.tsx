...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/guides/how-much-contingency/', languages: { 'en-AU': '/au/guides/how-much-contingency/', 'en-CA': '/ca/guides/how-much-contingency/', 'en-GB': '/guides/how-much-contingency/', 'en-US': '/us/guides/how-much-contingency/', 'x-default': '/guides/how-much-contingency/' } },
}
  ...
  return (
    <div className="guide">
      ...
      <p>
        ...
        straightforward like-for-like kitchen swap gets the same contingency as a loft
        conversion in a Victorian terrace with no survey. That makes no sense.
      </p>
      ...
      <ASCIIBox title="Same Contingency, Different Risk">
        <table className="guide__table">
          ...
          <tbody>
            <tr>
              <td>Fence replacement (known supplier, flat garden)</td>
              <td>£2,000</td>
              <td>£200</td>
              <td className="guide__highlight">~3% needed</td>
            </tr>
            <tr>
              <td>Bathroom strip-out (Victorian terrace, no survey)</td>
              <td>£8,000</td>
              <td>£800</td>
      ...
      <p>
        The fence job has £200 of contingency it does not need. The bathroom job has £800
        when it needs £1,440. One quote is padded. The other is dangerously thin. Both used
        the same &quot;10% rule.&quot;
      </p>
      ...
      <p>
        The skip hire does not need contingency — you have a fixed price. The custom joinery
        needs a lot — the workshop has never made this piece before, and it has to fit into
        a space you measured once. Flat percentages ignore this completely.
      </p>
      ...
      <p>
        A £300 skip with no uncertainty contributes almost nothing to your contingency. A
        £4,000 subcontractor quote marked as High contributes a lot. That is how risk

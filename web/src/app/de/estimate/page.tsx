...
export default function DeEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ BERECHNUNG LÄUFT... ]' : '[ SIMULATION STARTEN ]'}
      </button>
      {!canRun && (
        <div className="empty-state">Mindestens eine Position hinzufügen, um die Simulation zu starten</div>
      )}
    </div>
  )
}

...
export default function NlEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ BEREKENING LOOPT... ]' : '[ SIMULATIE STARTEN ]'}
      </button>
      {!canRun && (
        <div className="empty-state">voeg ten minste één post toe om de simulatie te starten</div>
      )}
    </div>
  )
}

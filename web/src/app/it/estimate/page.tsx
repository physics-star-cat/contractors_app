...
export default function ItEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ CALCOLO IN CORSO... ]' : '[ AVVIA SIMULAZIONE ]'}
      </button>
      {!canRun && (
        <div className="empty-state">aggiungi almeno una voce per avviare la simulazione</div>
      )}
    </div>
  )
}

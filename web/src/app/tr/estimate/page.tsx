...
export default function TrEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ HESAPLANIYOR... ]' : '[ SİMÜLASYONU ÇALIŞTIR ]'}
      </button>
      {!canRun && (
        <div className="empty-state">simülasyonu çalıştırmak için en az bir kalem ekleyin</div>
      )}
    </div>
  )
}

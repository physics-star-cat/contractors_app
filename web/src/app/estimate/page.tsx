...
export default function EstimatePage() {
  ...
  const handleRunSimulation = () => {
    ...
    // Use setTimeout to let the UI update before running the CPU-intensive simulation
    setTimeout(() => {
  ...
  return (
    <div className="estimator">
      ...
      {!canRun && (
        <div className="empty-state">add at least one line item to run simulation</div>
      )}
    </div>
  )
}

...
export default function PtEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ CALCULANDO... ]' : '[ EXECUTAR SIMULAÇÃO ]'}
      </button>
      {!canRun && (
        <div className="empty-state">adicione pelo menos um item para executar a simulação</div>
      )}
    </div>
  )
}

...
export default function AUMarkupVsMarginCalculatorPage() {
  ...
  return (
    <div>
      ...
      >
        Markup and margin are not the same thing. A lot of tradies get caught out by
        this — they think they are making 20% margin when they are actually making
        16.7%. This tool shows you both side by side in AUD so you can see the
        difference and price your jobs correctly.
      </p>

      <ASCIIBox title="Inputs">
        <div style={fieldStyle}>
          <label style={labelStyle}>cost price (AUD)</label>
          <input
            type="number"
            min="0"
            step="1"
      ...
      <ASCIIBox title="The difference explained">
        ...
        >
          They&apos;re not the same. Get this wrong and you are leaving money on the table
          on every single job.
        </p>
      </ASCIIBox>

...
export default function AUAboutPage() {
  return (
    <div>
      ...
      <ASCIIBox title="What is this">
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', marginBottom: '12px' }}>
          LowRiskQuotes is a free cost estimation tool for Australian tradies, builders,
          and anyone who needs to quote a job without underpricing it. All calculations
          are in AUD and geared towards the Australian construction market.
        </p>
      ...
      <ASCIIBox title="Built for Aussie tradies">
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7' }}>
          All pricing examples use AUD. Travel calculations use the ATO mileage rate
          ($0.85/km). Material references are Australian — Colorbond, besser blocks,
          Bunnings pricing, and local supplier rates. Whether you are a chippy, sparky,
          plumber, or builder, the tool works the same way.
        </p>
      </ASCIIBox>

...
export const metadata: Metadata = {
  ...
  description: 'How LowRiskQuotes uses Monte Carlo simulation to help contractors build safer quotes.',
    ...
    <div>
      ...
      <ASCIIBox title="What is this">
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.7', marginBottom: '12px' }}>
          ...
          anyone who needs to quote a job without underpricing it.
        </p>
      ...
      <div style={{ marginTop: '24px', fontSize: '13px' }}>
        <Link href="/guides/how-to-quote-a-job/" style={{ marginRight: '16px' }}>
          [READ THE GUIDE]
        </Link>
        <Link href="/estimate/">
          [START ESTIMATING]

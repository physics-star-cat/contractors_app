...
export default function USResultsPage() {
  ...
  return (
    <div className="results">
      <div className="results__hero">
        <div className="results__hero-label">recommended bid</div>
      ...
      <div className="results__actions">
        ...
        <Link href="/us/estimate/">[EDIT ESTIMATE]</Link>
      </div>

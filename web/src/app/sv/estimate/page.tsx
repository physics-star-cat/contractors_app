...
export default function SvEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ BERÄKNAR... ]' : '[ KÖR SIMULERING ]'}
      </button>
      {!canRun && (
        <div className="empty-state">lägg till minst en post för att köra simuleringen</div>
      )}
    </div>
  )
}

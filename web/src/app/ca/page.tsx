  ...
  return (
    <div className="home">
      <section className="home__hero">
        ...
        <p className="home__subtitle">monte carlo cost projections for Canadian contractors</p>
      </section>
      ...
      <section className="home__how-it-works">
        <ASCIIBox title="How it works">
          <div className="home__steps">
            ...
            <div className="home__step"><span className="home__step-num">[2]</span> Monte Carlo simulation runs 10,000 cost scenarios in CAD</div>
      ...
      <section className="home__preview">
        <ASCIIBox title="Example output (CAD)">
      ...
      <section className="home__seo">
        <p>
          LowRiskQuotes uses Monte Carlo simulation to help Canadian contractors and
          tradespeople build quotes that account for real-world uncertainty. Instead of adding
          a flat contingency percentage, simulate thousands of cost scenarios to find the price
          point where you are unlikely to lose money. All prices in Canadian dollars, with
          Canadian labour rates, HST/GST considerations, and CRA mileage allowances built in.
        </p>
        <p>

...
export default function DayRateVsFixedPricePageCA() {
  return (
    <div className="guide">
      ...
      <p>
        This is probably the most common argument in any trades group chat. Some
      ...
      <ul>
        ...
        <li>
          ...
          &quot;Actually, can we move that outlet?&quot; On day rate, no problem. On fixed
          price, that is a change order and an awkward conversation.
        </li>
        <li>
          <strong className="guide__highlight">It is T&amp;M work by nature.</strong>{' '}
          Maintenance, repairs, deficiency work. Jobs where you show up, see what needs doing,
          and fix it.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          install with specified cabinets, a bathroom to a drawn plan, a fence along a measured
      ...
      <p>
        ...
        honest uncertainty tiers and let the numbers tell you what to charge. Do not forget
        to include your travel at the CRA rate of $0.70/km — it adds up fast on jobs outside
        your area.
      </p>

...
export default function DayRateCalculatorPageCA() {
  ...
  return (
    <div>
      ...
      >
        ...
        monthly rate, and annual income in Canadian dollars. Adjust hours per day
        and days per week to match your working pattern. Remember to account for
        the CRA mileage rate of $0.70/km when calculating your effective hourly
        rate after travel costs.
      </p>

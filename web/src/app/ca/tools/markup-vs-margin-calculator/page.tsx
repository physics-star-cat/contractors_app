...
export default function MarkupVsMarginCalculatorPageCA() {
  ...
  return (
    <div>
      ...
      >
        markup vs margin calculator (CAD)
      </h1>
      ...
      >
        ...
        correctly. All values in Canadian dollars. Remember that HST/GST
        applies on top of your selling price.
      </p>

      <ASCIIBox title="Inputs">
        <div style={fieldStyle}>
          <label style={labelStyle}>cost price (CAD)</label>
          <input
            type="number"
            min="0"
            step="1"

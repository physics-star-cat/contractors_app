...
export default function PlEstimatePage() {
  ...
  return (
    <div className="estimator">
      ...
      <button
        ...
        type="button"
      >
        {isSimulating ? '[ OBLICZANIE... ]' : '[ URUCHOM SYMULACJĘ ]'}
      </button>
      {!canRun && (
        <div className="empty-state">dodaj przynajmniej jedną pozycję, aby uruchomić symulację</div>
      )}
    </div>
  )
}
